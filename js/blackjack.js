...
var storelosses = null



if ( localStorage.getItem('wons') &&  localStorage.getItem('losses') ){
   
    storelosses = JSON.parse(localStorage.getItem('losses') );

    storeWons = JSON.parse(localStorage.getItem('wons'));

    storeFunds = JSON.parse(localStorage.getItem('funds'))
    ...
    earnings.set('wons',storeWons);

    earnings.set('losses', storelosses);

    earnings.set('funds', storeFunds);
...
/*=== method for ending each round of a game  ===*/
  ...
  function endRound(){
    ...
    localStorage.setItem('wons', JSON.stringify(wons));
